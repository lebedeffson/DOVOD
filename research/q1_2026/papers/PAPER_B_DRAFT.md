...
On the final clean CI runner, median-per-case timing gives a mean count-DP versus posterior-vector speedup of approximately 6.33x, with minimum about 6.30x and maximum about 6.35x. These are engineering measurements, not hardware-independent complexity claims.
